          ...
          <div className="col col-d-6 col-t-6 col-m-12 border-line-v">
            ...
            <div className="resume-items">
              <div className="resume-item border-line-h active">
                <div className="date">Nov 2019 - April 2022</div>
                <div className="name">Senior Full Stack Software Developer</div>
                <div className="company">Theseus AI</div>
                {/* <p>
                  Angular / Python programming / architecture and the AWS ecosystem of services; including Lambda, API Gateway, Amplify, Cognito, Athena, S3, and others as needed
                </p> */}
              </div>
              <div className="resume-item border-line-h">
                <div className="date" >Dec 2018 - Oct 2019</div>
                <div className="name">Senior Full Stack Lead Developer</div>
                <div className="company">MailTag</div>
                {/* <p>
                  Email Tool Chrome extension from scratch Iterated testing the functionalities, bugfixing, and maintenance Successfully launched the app and get certification from Google
                </p> */}
              </div>
              <div className="resume-item border-line-h">
                <div className="date">Feb 2017 - Nov 2018</div>
                <div className="name">Senior Full Stack Engineer</div>
                <div className="company">rEvolution</div>
                {/* <p>
                  web and native mobile applications API design and development React, React Native, Nodejs, MySQL, Postgres, MongoDB, Docker, and Stripe integration
                </p> */}
              </div>
              <div className="resume-item">
                <div className="date">Mar 2015 - Dec 2016</div>
                <div className="name">Senior Software Developer</div>
                <div className="company">pozible</div>
                {/* <p>Wrote PHP, MySQL, and JavaScript / jQuery code for a web Application Responsible for implementing Version Control (Git) for our team </p> */}
              </div>
            </div>
          </div>
          {/* education */}
          <div className="col col-d-6 col-t-6 col-m-12 border-line-v">
            ...
            <div className="resume-items">
              <div className="resume-item border-line-h">
                ...
                <div className="name">Bachelor of Technology</div>
              ...
              <div className="resume-item border-line-h">
                ...
                <div className="name">Bachelor of Engineering</div>
                <div className="company">
                  University of Utah College of Engineering
                </div>
                <p> BE, Mathematics and Computer Science</p>
              </div>
              {/* <div className="resume-item">
